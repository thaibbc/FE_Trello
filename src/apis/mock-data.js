export const mockData = {
    board: {
      ...
      columnOrderIds: ['column-id-01', 'column-id-02', 'column-id-03','column-id-04-pleceholder-card'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
      columns: [
        {
          _id: 'column-id-01',
          boardId: 'board-id-01',
          ...
          cards: [
            {
              ...
              cover: 'https://cdn.tgdd.vn/Files/2020/06/08/1261696/moi-tai-bo-hinh-nen-asus-rog-2020-moi-nhat_800x450.jpg',
        ...
        {
          _id: 'column-id-04-pleceholder-card',
          boardId: 'board-id-01',
          title: 'Emty Column 04',
          cardOrderIds: ['card-id-14'],
          cards: [
            { _id: 'card-id-14', boardId: 'board-id-01', columnId: 'column-id-04-pleceholder-card', title: 'Title of card 14', FE_PleceholderCard: true}
          ]
        }
      ]
    }
